...
namespace SharePoint.FolderIds.Features.FolderId
{
    /// <summary>
    ...
    [Guid("33aae70a-2461-4f7a-8fa3-d99e5f42485d")]
    public class FolderIdEventReceiver : SPFeatureReceiver
    {
        ...
        {
            SPSite site = (SPSite)properties.Feature.Parent;
            FolderIdWorkItemJobDefinition.UnRegister(site.WebApplication);
